...
1. [Kaggle](Datods y kernels)
1. [Sciencie (Nature)](https://www.nature.com/sdata/policies/repositories)
1.[ Data Repositories](http://oad.simmons.edu/oadwiki/Data_repositories)
1.[UCI (Machine learning repository)](https://archive.ics.uci.edu/ml/datasets.ph)
